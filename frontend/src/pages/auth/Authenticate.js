...
const Authenticate = ({ setToken, setId, setUser, setMessage, setClassName, setShow, setSuperuser, setLoading }) => {
    ...
    const LoginSubmit = e => {
        ...
        axios.post('https://localhost:443/rest-auth/signin/', loginData)
            .then(response => {
    ...
    const SignupSubmit = e => {
        ...
        axios.post('https://localhost:443/rest-auth/register/', signupData)
            .then(res => {
                setShow(true);
                setTimeout(() => setShow(false), 3500);
                setClassName(`bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md transition duration-300 ease-in-out`);
    ...
    const ForgotPasswordSubmit = e => {
        ...
        axios.post('https://localhost:443/rest-auth/password-reset/', resetData)
            .then(res => {
                setShow(true);
                setTimeout(() => setShow(false), 3500);
                setClassName(`bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md transition duration-300 ease-in-out`);
    ...
    const googleAuth = () => {
        ...
        const callBackURI = "https://localhost:443/";
